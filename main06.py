...
capacity_df.index = range(len(capacity_df))  # reset index to 0..T-1


time_index = list(capacity_df.index)

capacity_dict = {
    (t, s): capacity_df.loc[t, s]
    for t in capacity_df.index
    for s in capacity_df.columns
}
